# This Makefile is for the Regexp::IPv6 extension to perl.
#
...
#     AUTHOR => [q[Wesley Schwengle]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[Regexp::IPv6]
#     PREREQ_PM => {  }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Regexp/Common/IP.pm]
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Regexp/Common/IP.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Regexp
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Regexp
...
TO_INST_PM = lib/Regexp/Common/IP.pm

PM_TO_BLIB = lib/Regexp/Common/IP.pm \
	blib/lib/Regexp/Common/IP.pm
...
DISTNAME = Regexp-IPv6
DISTVNAME = Regexp-IPv6-0.04
...
manifypods : pure_all  \
	lib/Regexp/Common/IP.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Regexp/Common/IP.pm $(INST_MAN3DIR)/Regexp::Common::IP.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  - '\''Wesley Schwengle'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Regexp-IPv6' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '      "Wesley Schwengle"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Regexp-IPv6",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Wesley Schwengle</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Regexp/Common/IP.pm blib/lib/Regexp/Common/IP.pm 
